...
@include('stok.penggunaanbahanbaku.tambah_penggunaanbahanbaku')
...
<article class="content">
	...
	<div class="title-block text-primary">
	    ...
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> / <span>Stok</span> / <span class="text-primary" style="font-weight: bold;">Penggunaan Bahan Baku</span>
	     </p>
	</div>
