	                                	...
	                                	<tr>
	                                		...
	                                		<td>
	                                			<div class="btn-group btn-group-sm">
	                                				<button class="btn btn-warning btn-edit" onclick="window.location.href='{{ route('edit_datamesin') }}'" type="button" title="Edit"><i class="fa fa-pencil"></i></button>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $('#table_mesin tbody').on('click','.btn-edit', function(){
			window.location.href='{{route('edit_datamesin')}}'
		})
