...
@include('keuangan.prosesinputtransaksi.modal_memorial')

<article class="content">

	<div class="title-block text-primary">
	    <h1 class="title">  Input Transaksi Memorial </h1>
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> 
	    	/ <span>Keuangan</span> 
	    	/ <span>Proses Input Transaksi</span>
	    	/ <a href="{{route('pilih_prosesinputtransaksi')}}">Pilih Transaksi</a>
	    	/ <span class="text-primary font-weight-bold"> Input Transaksi Memorial</span>
	     </p>
	</div>
				...
				<div class="card">
                    <div class="card-header bordered p-2">
                    	<div class="header-block">
	                        <h3 class="title">  Input Transaksi Memorial </h3>
	                    </div>
                        					...
                        					<div class="form-group">
                        						<div class="input-group">
	                        						<select class="form-control form-control-sm" name="">
	                        							<option>Memorial Debet</option>
	                        							<option>Memorial Kredit</option>
	                        						</select>
