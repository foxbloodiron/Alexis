...
@include('keuangan.prosesinputtransaksi.modal_bank')

<article class="content">

	<div class="title-block text-primary">
	    <h1 class="title">  Input Transaksi Bank </h1>
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a> 
	    	/ <span>Keuangan</span> 
	    	/ <span>Proses Input Transaksi</span>
	    	/ <a href="{{route('pilih_prosesinputtransaksi')}}">Pilih Transaksi</a>
	    	/ <span class="text-primary font-weight-bold"> Input Transaksi Bank</span>
	     </p>
	</div>
				...
				<div class="card">
                    <div class="card-header bordered p-2">
                    	<div class="header-block">
	                        <h3 class="title">  Input Transaksi Bank </h3>
	                    </div>
                        	...
                        	<div class="row">
                        		<div class="col-md-6 col-sm-12">
                        			...
                        			<div class="row">
                        				...
                        				<div class="col-md-5 col-sm-12">
                        					<label>Type Transaksi Bank</label>
                        				</div>
                        					...
                        					<div class="form-group">
                        						<div class="input-group">
	                        						<select class="form-control form-control-sm" name="">
	                        							<option>BM - Transaksi Bank Masuk</option>
	                        							<option>BK - Transaksi Bank Keluar</option>
	                        						</select>
