			...
			<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="box-shadow: 0px 5px 10px #555;">
			    ...
			    <div class="collapse navbar-collapse" id="navbarCollapse">
			      <ul class="navbar-nav ml-auto">
			      	...
			      	<li class="nav-item">
			      	  <a href="{{ route('laporankeuangan') }}" style="color: #ffbb33;">
...
{{-- 					@php
			    	...
			    	<div style="padding-top: 20px;">
						...
						<table class="table" id="table-data" {{-- v-for="(data, index) in dataPrint" :style="(index > 0) ? 'margin-top: 40px;' : '0px'" v-cloak --}}>
							<tbody>
								<tr>
									<th class="head" colspan="8" style="background-color: #0099CC; color: white; text-align: left;"> {{-- @{{ data.ak_id+" - "+data.ak_nama }} --}} 1.001.001 - Kas Kecil</th>
								</tr>
